...
const NotificationCard = ({ icon, tag, title, body, delay, className }) => (
  ...
  >
    ...
    <p className="font-headline font-bold text-xs text-on-surface leading-tight mb-1">{title}</p>
...
function Login() {
  ...
  return (
    <motion.div variants={pageVariants} initial="hidden" animate="visible" className="min-h-screen flex overflow-hidden">
      {/* Left panel */}
      <motion.div
      ...
      >
        ...
        <motion.div
          ...
          style={{ background: "rgb(var(--cf-accent) / 0.30)", filter: "blur(50px)" }}
        />
        ...
        <div className="relative z-10 flex flex-col h-full">
          <div className="flex items-center gap-2">
            ...
            <span className="font-headline font-bold text-base text-white tracking-tight">CampusFlow</span>
          </div>
          ...
          <div className="flex-1 flex flex-col justify-center mt-12">
            ...
            >
              Manage bookings, track resources, and stay connected with your campus. Your all-in-one{" "}
      ...
      {/* Right panel */}
      <motion.div variants={formVariants} className="flex-1 flex flex-col bg-surface">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
          <div className="w-full max-w-md">
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="font-headline text-3xl font-extrabold text-on-surface tracking-tight mb-1.5">Sign In</h1>
              <p className="text-sm text-on-surface/55">
                Access your campus <span className="editorial-text text-primary text-base">dashboard</span>
              </p>
            </motion.div>
